...
SLANG_FORCE_INLINE SLANG_CUDA_CALL float F32_log1p(float f) { return ::log1pf(f); }
...
SLANG_FORCE_INLINE SLANG_CUDA_CALL float F32_expm1(float f) { return ::expm1f(f); }
...
{
    return make_float3 (0.28209480643272399902f) * feat_1.f0_0 + make_float3 (0.5f);
}

__device__ float3  eval_sh_col1_0(float3  dir_1, Features_0 feat_2)
{
    return make_float3 (-0.48860251903533935547f * dir_1.y) * feat_2.f1_0 + make_float3 (0.48860251903533935547f * dir_1.z) * feat_2.f2_0 - make_float3 (0.48860251903533935547f * dir_1.x) * feat_2.f3_0;
}
...
__device__ float3  eval_sh_col2_0(float3  dir_2, Features_0 feat_3)
{
    ...
    float xx_0 = x_3 * x_3;
    float yy_0 = y_1 * y_1;
    return make_float3 (1.09254848957061767578f * (x_3 * y_1)) * feat_3.f4_0 + make_float3 (-1.09254848957061767578f * (y_1 * z_0)) * feat_3.f5_0 + make_float3 (0.3153915703296661377f * (2.0f * (z_0 * z_0) - xx_0 - yy_0)) * feat_3.f6_0 + make_float3 (-1.09254848957061767578f * (x_3 * z_0)) * feat_3.f7_0 + make_float3 (0.54627424478530883789f * (xx_0 - yy_0)) * feat_3.f8_0;
}
...
__device__ float3  eval_sh_col3_0(float3  dir_3, Features_0 feat_4)
{
    ...
    return make_float3 (-0.59004360437393188477f * y_2 * (_S24 - yy_1)) * feat_4.f9_0 + make_float3 (2.89061141014099121094f * (x_4 * y_2) * z_1) * feat_4.f10_0 + make_float3 (-0.45704579353332519531f * y_2 * _S25) * feat_4.f11_0 + make_float3 (0.37317633628845214844f * z_1 * (2.0f * zz_0 - _S24 - _S26)) * feat_4.f12_0 + make_float3 (-0.45704579353332519531f * x_4 * _S25) * feat_4.f13_0 + make_float3 (1.44530570507049560547f * z_1 * (xx_1 - yy_1)) * feat_4.f14_0 + make_float3 (-0.59004360437393188477f * x_4 * (xx_1 - _S26)) * feat_4.f15_0;
}
...
__device__ void s_bwd_prop_eval_sh_col3_0(DiffPair_float3_0 * dpdir_0, DiffPair_Features_0 * dpfeat_0, float3  _s_dOut_0)
{
    ...
    float yy_2 = y_3 * y_3;
    float zz_1 = z_2 * z_2;
    float _S34 = -0.59004360437393188477f * y_3;
    float _S35 = 3.0f * xx_2;
    float _S36 = _S35 - yy_2;
    float _S37 = 2.89061141014099121094f * (x_5 * y_3);
    float _S38 = -0.45704579353332519531f * y_3;
    float _S39 = 4.0f * zz_1 - xx_2 - yy_2;
    float _S40 = 0.37317633628845214844f * z_2;
    float _S41 = 3.0f * yy_2;
    float _S42 = 2.0f * zz_1 - _S35 - _S41;
    float _S43 = -0.45704579353332519531f * x_5;
    float _S44 = 1.44530570507049560547f * z_2;
    float _S45 = xx_2 - yy_2;
    float _S46 = -0.59004360437393188477f * x_5;
    ...
    float s_diff_xy_T_0 = 2.89061141014099121094f * (z_2 * _S71);
    ...
    float _S79 = 1.44530570507049560547f * (_S45 * _S54) + 0.37317633628845214844f * (_S42 * _S61) + _S37 * _S71 + _S76 + _S76;
    float _S80 = -0.45704579353332519531f * (_S39 * _S66) + -0.59004360437393188477f * (_S36 * _S74) + x_5 * s_diff_xy_T_0 + _S77 + _S77;
    float _S81 = -0.59004360437393188477f * (_S47 * _S50) + -0.45704579353332519531f * (_S39 * _S58) + y_3 * s_diff_xy_T_0 + _S78 + _S78;
    s_diff_Features_0 _S82 = Features_x24_syn_dzero_0();
    (&_S82)->f15_1 = _S48;
    (&_S82)->f14_1 = _S52;
    (&_S82)->f13_1 = _S56;
    (&_S82)->f12_1 = _S59;
...
__device__ void s_bwd_prop_eval_sh_col2_0(DiffPair_float3_0 * dpdir_1, DiffPair_Features_0 * dpfeat_1, float3  _s_dOut_1)
{
    ...
    float xx_3 = x_6 * x_6;
    float yy_3 = y_4 * y_4;
    float3  _S84 = make_float3 (0.54627424478530883789f * (xx_3 - yy_3)) * _s_dOut_1;
    float3  _S85 = (*dpfeat_1).primal_0.f8_0 * _s_dOut_1;
    float _S86 = 0.54627424478530883789f * (_S85.x + _S85.y + _S85.z);
    float3  _S87 = make_float3 (-1.09254848957061767578f * (x_6 * z_3)) * _s_dOut_1;
    float3  _S88 = (*dpfeat_1).primal_0.f7_0 * _s_dOut_1;
    float s_diff_xz_T_0 = -1.09254848957061767578f * (_S88.x + _S88.y + _S88.z);
    float3  _S89 = make_float3 (0.3153915703296661377f * (2.0f * (z_3 * z_3) - xx_3 - yy_3)) * _s_dOut_1;
    float3  _S90 = (*dpfeat_1).primal_0.f6_0 * _s_dOut_1;
    float _S91 = 0.3153915703296661377f * (_S90.x + _S90.y + _S90.z);
    float _S92 = - _S91;
    float3  _S93 = make_float3 (-1.09254848957061767578f * (y_4 * z_3)) * _s_dOut_1;
    float3  _S94 = (*dpfeat_1).primal_0.f5_0 * _s_dOut_1;
    float s_diff_yz_T_0 = -1.09254848957061767578f * (_S94.x + _S94.y + _S94.z);
    float3  _S95 = make_float3 (1.09254848957061767578f * (x_6 * y_4)) * _s_dOut_1;
    float3  _S96 = (*dpfeat_1).primal_0.f4_0 * _s_dOut_1;
    float s_diff_xy_T_1 = 1.09254848957061767578f * (_S96.x + _S96.y + _S96.z);
    ...
    s_diff_Features_0 _S103 = Features_x24_syn_dzero_0();
    (&_S103)->f8_1 = _S84;
    (&_S103)->f7_1 = _S87;
    (&_S103)->f6_1 = _S89;
    (&_S103)->f5_1 = _S93;
...
__device__ void s_bwd_prop_eval_sh_col1_0(DiffPair_float3_0 * dpdir_2, DiffPair_Features_0 * dpfeat_2, float3  s_diff_color_T_0)
{
    float3  _S105 = - s_diff_color_T_0;
    float3  _S106 = make_float3 (0.48860251903533935547f * (*dpdir_2).primal_0.x) * _S105;
    float3  _S107 = (*dpfeat_2).primal_0.f3_0 * _S105;
    float s_diff_x_T_0 = 0.48860251903533935547f * (_S107.x + _S107.y + _S107.z);
    float3  _S108 = make_float3 (0.48860251903533935547f * (*dpdir_2).primal_0.z) * s_diff_color_T_0;
    float3  _S109 = (*dpfeat_2).primal_0.f2_0 * s_diff_color_T_0;
    float s_diff_z_T_0 = 0.48860251903533935547f * (_S109.x + _S109.y + _S109.z);
    float3  _S110 = make_float3 (-0.48860251903533935547f * (*dpdir_2).primal_0.y) * s_diff_color_T_0;
    float3  _S111 = (*dpfeat_2).primal_0.f1_0 * s_diff_color_T_0;
    float s_diff_y_T_0 = -0.48860251903533935547f * (_S111.x + _S111.y + _S111.z);
    s_diff_Features_0 _S112 = Features_x24_syn_dzero_0();
    (&_S112)->f3_1 = _S106;
    (&_S112)->f2_1 = _S108;
    (&_S112)->f1_1 = _S110;
...
__device__ void s_bwd_prop_eval_sh_col0_0(DiffPair_float3_0 * dpdir_3, DiffPair_Features_0 * dpfeat_3, float3  _s_dOut_2)
{
    float3  _S114 = make_float3 (0.28209480643272399902f) * _s_dOut_2;
...
__device__ void s_bwd_prop_eval_color_0(DiffPair_float3_0 * dpdir_4, DiffPair_Features_0 * dpfeat_4, uint sh_degree_3, float3  _s_dOut_3)
{
    DiffPair_float3_0 _S117 = *dpdir_4;
    ...
    s_diff_Features_0 _S125 = Features_x24_syn_dzero_0();
    s_diff_Features_0 _S126;
    float3  _S127;
    if(_S119)
    {
        if(_S120)
    ...
    s_diff_Features_0 _S138 = Features_x24_syn_dadd_0(_S137.differential_0, _S126);
...
__device__ void s_bwd_eval_color_0(DiffPair_float3_0 * _S140, DiffPair_Features_0 * _S141, uint _S142, float3  _S143)
{
...
__global__ void __kernel__bw_sh_kernel(TensorView means_1, TensorView features_2, TensorView dL_dfeatures_0, TensorView ray_origin_1, TensorView dL_dcolors_0, uint sh_degree_4)
{
    ...
    if((F32_abs((deriv_color_0.x))) < 0.00000000999999993923f && (F32_abs((deriv_color_0.y))) < 0.00000000999999993923f && (F32_abs((deriv_color_0.z))) < 0.00000000999999993923f)
    {
        return;
    }
    ...
    float3  _S148 = make_float3 (0.0f, 0.0f, 0.0f);
    DiffPair_float3_0 deriv_direction_0;
    (&deriv_direction_0)->primal_0 = dir_pp_1;
    (&deriv_direction_0)->differential_0 = _S148;
    s_diff_Features_0 _S149 = { _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148, _S148 };
    DiffPair_Features_0 d_feat_0;
    (&d_feat_0)->primal_0 = feat_7;
    (&d_feat_0)->differential_0 = _S149;
    s_bwd_eval_color_0(&deriv_direction_0, &d_feat_0, sh_degree_4, deriv_color_0);
    add_float3_0(dL_dfeatures_0, prim_ind_2, 0U, d_feat_0.differential_0.f0_1);
    if(sh_degree_4 > 0U)
    {
        add_float3_0(dL_dfeatures_0, prim_ind_2, 1U, d_feat_0.differential_0.f1_1);
        add_float3_0(dL_dfeatures_0, prim_ind_2, 2U, d_feat_0.differential_0.f2_1);
        add_float3_0(dL_dfeatures_0, prim_ind_2, 3U, d_feat_0.differential_0.f3_1);
        if(sh_degree_4 > 1U)
        {
            add_float3_0(dL_dfeatures_0, prim_ind_2, 4U, d_feat_0.differential_0.f4_1);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 5U, d_feat_0.differential_0.f5_1);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 6U, d_feat_0.differential_0.f6_1);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 7U, d_feat_0.differential_0.f7_1);
            add_float3_0(dL_dfeatures_0, prim_ind_2, 8U, d_feat_0.differential_0.f8_1);
            if(sh_degree_4 > 2U)
            {
                add_float3_0(dL_dfeatures_0, prim_ind_2, 9U, d_feat_0.differential_0.f9_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 10U, d_feat_0.differential_0.f10_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 11U, d_feat_0.differential_0.f11_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 12U, d_feat_0.differential_0.f12_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 13U, d_feat_0.differential_0.f13_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 14U, d_feat_0.differential_0.f14_1);
                add_float3_0(dL_dfeatures_0, prim_ind_2, 15U, d_feat_0.differential_0.f15_1);
            }
        }
    }
    return;
