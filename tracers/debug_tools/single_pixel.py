...
from splinetracers.fast_ellipsoid_splinetracer import trace_rays
# from splinetracers.tetra_splinetracer import trace_rays
# from splinetracers.gaussian_alphacomp import trace_rays
# from splinetracers.ellipsoid_alphacomp import trace_rays
import torch
import numpy as np
...
input_densities = inv_opacity(opacities) / 2 if trace_rays.uses_density else opacities
