...
__device__ Features_0 get_feats_0(TensorView sh0_0, TensorView features_0, uint prim_ind_0, uint sh_degree_0)
{
    Features_0 feat_0;
    float3  _S7 = get_float3_0(sh0_0, prim_ind_0);
    (&feat_0)->f0_0 = _S7;
    if(sh_degree_0 > 0U)
    {
        float3  _S8 = get_float3_1(features_0, prim_ind_0, 0U);
        (&feat_0)->f1_0 = _S8;
        float3  _S9 = get_float3_1(features_0, prim_ind_0, 1U);
        (&feat_0)->f2_0 = _S9;
        float3  _S10 = get_float3_1(features_0, prim_ind_0, 2U);
        (&feat_0)->f3_0 = _S10;
        if(sh_degree_0 > 1U)
        {
            float3  _S11 = get_float3_1(features_0, prim_ind_0, 3U);
            (&feat_0)->f4_0 = _S11;
            float3  _S12 = get_float3_1(features_0, prim_ind_0, 4U);
            (&feat_0)->f5_0 = _S12;
            float3  _S13 = get_float3_1(features_0, prim_ind_0, 5U);
            (&feat_0)->f6_0 = _S13;
            float3  _S14 = get_float3_1(features_0, prim_ind_0, 6U);
            (&feat_0)->f7_0 = _S14;
            float3  _S15 = get_float3_1(features_0, prim_ind_0, 7U);
            (&feat_0)->f8_0 = _S15;
            if(sh_degree_0 > 2U)
            {
                float3  _S16 = get_float3_1(features_0, prim_ind_0, 8U);
                (&feat_0)->f9_0 = _S16;
                float3  _S17 = get_float3_1(features_0, prim_ind_0, 9U);
                (&feat_0)->f10_0 = _S17;
                float3  _S18 = get_float3_1(features_0, prim_ind_0, 10U);
                (&feat_0)->f11_0 = _S18;
                float3  _S19 = get_float3_1(features_0, prim_ind_0, 11U);
                (&feat_0)->f12_0 = _S19;
                float3  _S20 = get_float3_1(features_0, prim_ind_0, 12U);
                (&feat_0)->f13_0 = _S20;
                float3  _S21 = get_float3_1(features_0, prim_ind_0, 13U);
                (&feat_0)->f14_0 = _S21;
                float3  _S22 = get_float3_1(features_0, prim_ind_0, 14U);
                (&feat_0)->f15_0 = _S22;
            }
        }
    }
...
__device__ s_diff_Features_0 Features_x24_syn_dzero_0()
{
    s_diff_Features_0 result_2;
...
__device__ s_diff_Features_0 Features_x24_syn_dadd_0(s_diff_Features_0 SLANG_anonymous_0_0, s_diff_Features_0 SLANG_anonymous_1_0)
{
    s_diff_Features_0 result_3;
    (&result_3)->f0_1 = SLANG_anonymous_0_0.f0_1 + SLANG_anonymous_1_0.f0_1;
    (&result_3)->f1_1 = SLANG_anonymous_0_0.f1_1 + SLANG_anonymous_1_0.f1_1;
    (&result_3)->f2_1 = SLANG_anonymous_0_0.f2_1 + SLANG_anonymous_1_0.f2_1;
    (&result_3)->f3_1 = SLANG_anonymous_0_0.f3_1 + SLANG_anonymous_1_0.f3_1;
    (&result_3)->f4_1 = SLANG_anonymous_0_0.f4_1 + SLANG_anonymous_1_0.f4_1;
    (&result_3)->f5_1 = SLANG_anonymous_0_0.f5_1 + SLANG_anonymous_1_0.f5_1;
    (&result_3)->f6_1 = SLANG_anonymous_0_0.f6_1 + SLANG_anonymous_1_0.f6_1;
    (&result_3)->f7_1 = SLANG_anonymous_0_0.f7_1 + SLANG_anonymous_1_0.f7_1;
    (&result_3)->f8_1 = SLANG_anonymous_0_0.f8_1 + SLANG_anonymous_1_0.f8_1;
    (&result_3)->f9_1 = SLANG_anonymous_0_0.f9_1 + SLANG_anonymous_1_0.f9_1;
    (&result_3)->f10_1 = SLANG_anonymous_0_0.f10_1 + SLANG_anonymous_1_0.f10_1;
    (&result_3)->f11_1 = SLANG_anonymous_0_0.f11_1 + SLANG_anonymous_1_0.f11_1;
    (&result_3)->f12_1 = SLANG_anonymous_0_0.f12_1 + SLANG_anonymous_1_0.f12_1;
    (&result_3)->f13_1 = SLANG_anonymous_0_0.f13_1 + SLANG_anonymous_1_0.f13_1;
    (&result_3)->f14_1 = SLANG_anonymous_0_0.f14_1 + SLANG_anonymous_1_0.f14_1;
    (&result_3)->f15_1 = SLANG_anonymous_0_0.f15_1 + SLANG_anonymous_1_0.f15_1;
    return result_3;
}
...
extern "C" {
__global__ void __kernel__sh_kernel(TensorView means_0, TensorView sh0_1, TensorView features_1, TensorView ray_origin_0, TensorView colors_0, uint sh_degree_2)
{
    ...
    Features_0 feat_6 = get_feats_0(sh0_1, features_1, prim_ind_1, sh_degree_2);
...
__device__ void add_float3_0(TensorView view_2, uint ind_2, float3  val_0)
{
    float _S31 = ((view_2).load<float>((ind_2), (0U)));
    (view_2).store<float>((ind_2), (0U), (_S31 + val_0.x));
    float _S32 = ((view_2).load<float>((ind_2), (1U)));
    (view_2).store<float>((ind_2), (1U), (_S32 + val_0.y));
    float _S33 = ((view_2).load<float>((ind_2), (2U)));
    (view_2).store<float>((ind_2), (2U), (_S33 + val_0.z));
    return;
}

__device__ void add_float3_1(TensorView view_3, uint ind_3, uint feat_ind_1, float3  val_1)
{
    float _S34 = ((view_3).load<float>((ind_3), (feat_ind_1), (0U)));
    (view_3).store<float>((ind_3), (feat_ind_1), (0U), (_S34 + val_1.x));
    float _S35 = ((view_3).load<float>((ind_3), (feat_ind_1), (1U)));
    (view_3).store<float>((ind_3), (feat_ind_1), (1U), (_S35 + val_1.y));
    float _S36 = ((view_3).load<float>((ind_3), (feat_ind_1), (2U)));
    (view_3).store<float>((ind_3), (feat_ind_1), (2U), (_S36 + val_1.z));
    return;
}
...
{
    Features_0 primal_0;
    s_diff_Features_0 differential_0;
};
...
__device__ void s_bwd_prop_eval_sh_col3_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_0, DiffPair_Features_0 * dpfeat_0, float3  _s_dOut_0)
{
    ...
    float yy_2 = y_3 * y_3;
    float zz_1 = z_2 * z_2;
    float _S37 = -0.59004360437393188f * y_3;
    float _S38 = 3.0f * xx_2;
    float _S39 = _S38 - yy_2;
    float _S40 = 2.89061141014099121f * (x_5 * y_3);
    float _S41 = -0.4570457935333252f * y_3;
    float _S42 = 4.0f * zz_1 - xx_2 - yy_2;
    float _S43 = 0.37317633628845215f * z_2;
    float _S44 = 3.0f * yy_2;
    float _S45 = 2.0f * zz_1 - _S38 - _S44;
    float _S46 = -0.4570457935333252f * x_5;
    float _S47 = 1.44530570507049561f * z_2;
    float _S48 = xx_2 - yy_2;
    float _S49 = -0.59004360437393188f * x_5;
    float _S50 = xx_2 - _S44;
    float3  _S51 = make_float3 (_S49 * _S50) * _s_dOut_0;
    float3  _S52 = (*dpfeat_0).primal_0.f15_0 * _s_dOut_0;
    float _S53 = _S52.x + _S52.y + _S52.z;
    float _S54 = _S49 * _S53;
    float3  _S55 = make_float3 (_S47 * _S48) * _s_dOut_0;
    float3  _S56 = (*dpfeat_0).primal_0.f14_0 * _s_dOut_0;
    float _S57 = _S56.x + _S56.y + _S56.z;
    float _S58 = _S47 * _S57;
    float3  _S59 = make_float3 (_S46 * _S42) * _s_dOut_0;
    float3  _S60 = (*dpfeat_0).primal_0.f13_0 * _s_dOut_0;
    float _S61 = _S60.x + _S60.y + _S60.z;
    float3  _S62 = make_float3 (_S43 * _S45) * _s_dOut_0;
    float3  _S63 = (*dpfeat_0).primal_0.f12_0 * _s_dOut_0;
    float _S64 = _S63.x + _S63.y + _S63.z;
    float _S65 = _S43 * _S64;
    float _S66 = - _S65;
    float3  _S67 = make_float3 (_S41 * _S42) * _s_dOut_0;
    float3  _S68 = (*dpfeat_0).primal_0.f11_0 * _s_dOut_0;
    float _S69 = _S68.x + _S68.y + _S68.z;
    float _S70 = _S46 * _S61 + _S41 * _S69;
    float _S71 = - _S70;
    float3  _S72 = make_float3 (_S40 * z_2) * _s_dOut_0;
    float3  _S73 = (*dpfeat_0).primal_0.f10_0 * _s_dOut_0;
    float _S74 = _S73.x + _S73.y + _S73.z;
    float s_diff_xy_T_0 = 2.89061141014099121f * (z_2 * _S74);
    float3  _S75 = make_float3 (_S37 * _S39) * _s_dOut_0;
    float3  _S76 = (*dpfeat_0).primal_0.f9_0 * _s_dOut_0;
    float _S77 = _S76.x + _S76.y + _S76.z;
    float _S78 = _S37 * _S77;
    float _S79 = z_2 * (2.0f * _S65 + 4.0f * _S70);
    float _S80 = y_3 * (- _S58 + 3.0f * (- _S54 + _S66) + _S71 + - _S78);
    float _S81 = x_5 * (_S54 + _S58 + _S71 + 3.0f * (_S66 + _S78));
    float _S82 = 1.44530570507049561f * (_S48 * _S57) + 0.37317633628845215f * (_S45 * _S64) + _S40 * _S74 + _S79 + _S79;
    float _S83 = -0.4570457935333252f * (_S42 * _S69) + -0.59004360437393188f * (_S39 * _S77) + x_5 * s_diff_xy_T_0 + _S80 + _S80;
    float _S84 = -0.59004360437393188f * (_S50 * _S53) + -0.4570457935333252f * (_S42 * _S61) + y_3 * s_diff_xy_T_0 + _S81 + _S81;
    s_diff_Features_0 _S85 = Features_x24_syn_dzero_0();
    (&_S85)->f15_1 = _S51;
    (&_S85)->f14_1 = _S55;
    (&_S85)->f13_1 = _S59;
    (&_S85)->f12_1 = _S62;
    ...
    dpfeat_0->differential_0 = _S85;
    float3  _S86 = make_float3 (_S84, _S83, _S82);
    dpdir_0->primal_0 = (*dpdir_0).primal_0;
    dpdir_0->differential_0 = _S86;
    return;
}
...
__device__ void s_bwd_prop_eval_sh_col2_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpdir_1, DiffPair_Features_0 * dpfeat_1, float3  _s_dOut_1)
{
    ...
    float xx_3 = x_6 * x_6;
    float yy_3 = y_4 * y_4;
    float3  _S87 = make_float3 (0.54627424478530884f * (xx_3 - yy_3)) * _s_dOut_1;
    float3  _S88 = (*dpfeat_1).primal_0.f8_0 * _s_dOut_1;
    float _S89 = 0.54627424478530884f * (_S88.x + _S88.y + _S88.z);
    float3  _S90 = make_float3 (-1.09254848957061768f * (x_6 * z_3)) * _s_dOut_1;
    float3  _S91 = (*dpfeat_1).primal_0.f7_0 * _s_dOut_1;
    float s_diff_xz_T_0 = -1.09254848957061768f * (_S91.x + _S91.y + _S91.z);
    float3  _S92 = make_float3 (0.31539157032966614f * (2.0f * (z_3 * z_3) - xx_3 - yy_3)) * _s_dOut_1;
    float3  _S93 = (*dpfeat_1).primal_0.f6_0 * _s_dOut_1;
    float _S94 = 0.31539157032966614f * (_S93.x + _S93.y + _S93.z);
    float _S95 = - _S94;
    float3  _S96 = make_float3 (-1.09254848957061768f * (y_4 * z_3)) * _s_dOut_1;
    float3  _S97 = (*dpfeat_1).primal_0.f5_0 * _s_dOut_1;
    float s_diff_yz_T_0 = -1.09254848957061768f * (_S97.x + _S97.y + _S97.z);
    float3  _S98 = make_float3 (1.09254848957061768f * (x_6 * y_4)) * _s_dOut_1;
    float3  _S99 = (*dpfeat_1).primal_0.f4_0 * _s_dOut_1;
    float s_diff_xy_T_1 = 1.09254848957061768f * (_S99.x + _S99.y + _S99.z);
    float _S100 = z_3 * (2.0f * _S94);
    float _S101 = y_4 * (- _S89 + _S95);
    float _S102 = x_6 * (_S89 + _S95);
    float _S103 = x_6 * s_diff_xz_T_0 + y_4 * s_diff_yz_T_0 + _S100 + _S100;
    float _S104 = z_3 * s_diff_yz_T_0 + x_6 * s_diff_xy_T_1 + _S101 + _S101;
    float _S105 = z_3 * s_diff_xz_T_0 + y_4 * s_diff_xy_T_1 + _S102 + _S102;
    s_diff_Features_0 _S106 = Features_x24_syn_dzero_0();
    (&_S106)->f8_1 = _S87;
    (&_S106)->f7_1 = _S90;
    (&_S106)->f6_1 = _S92;
    (&_S106)->f5_1 = _S96;
    ...
    dpfeat_1->differential_0 = _S106;
    float3  _S107 = make_float3 (_S105, _S104, _S103);
    dpdir_1->primal_0 = (*dpdir_1).primal_0;
    dpdir_1->differential_0 = _S107;
    return;
}
...
{
    float3  _S108 = - s_diff_color_T_0;
    float3  _S109 = make_float3 (0.48860251903533936f * (*dpdir_2).primal_0.x) * _S108;
    float3  _S110 = (*dpfeat_2).primal_0.f3_0 * _S108;
    float s_diff_x_T_0 = 0.48860251903533936f * (_S110.x + _S110.y + _S110.z);
    float3  _S111 = make_float3 (0.48860251903533936f * (*dpdir_2).primal_0.z) * s_diff_color_T_0;
    float3  _S112 = (*dpfeat_2).primal_0.f2_0 * s_diff_color_T_0;
    float s_diff_z_T_0 = 0.48860251903533936f * (_S112.x + _S112.y + _S112.z);
    float3  _S113 = make_float3 (-0.48860251903533936f * (*dpdir_2).primal_0.y) * s_diff_color_T_0;
    float3  _S114 = (*dpfeat_2).primal_0.f1_0 * s_diff_color_T_0;
    float s_diff_y_T_0 = -0.48860251903533936f * (_S114.x + _S114.y + _S114.z);
    s_diff_Features_0 _S115 = Features_x24_syn_dzero_0();
    (&_S115)->f3_1 = _S109;
    (&_S115)->f2_1 = _S111;
    (&_S115)->f1_1 = _S113;
    dpfeat_2->primal_0 = (*dpfeat_2).primal_0;
    dpfeat_2->differential_0 = _S115;
    float3  _S116 = make_float3 (s_diff_x_T_0, s_diff_y_T_0, s_diff_z_T_0);
    dpdir_2->primal_0 = (*dpdir_2).primal_0;
    dpdir_2->differential_0 = _S116;
    return;
}
...
{
    float3  _S117 = make_float3 (0.282094806432724f) * _s_dOut_2;
    s_diff_Features_0 _S118 = Features_x24_syn_dzero_0();
    (&_S118)->f0_1 = _S117;
    dpfeat_3->primal_0 = (*dpfeat_3).primal_0;
    dpfeat_3->differential_0 = _S118;
    float3  _S119 = make_float3 (0.0f);
    dpdir_3->primal_0 = (*dpdir_3).primal_0;
    dpdir_3->differential_0 = _S119;
    return;
}
...
{
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S120 = *dpdir_4;
    DiffPair_Features_0 _S121 = *dpfeat_4;
    bool _S122 = sh_degree_3 > 0U;
    bool _S123;
    bool _S124;
    if(_S122)
    {
        bool _S125 = sh_degree_3 > 1U;
        if(_S125)
        {
            _S123 = sh_degree_3 > 2U;
        }
        else
        {
            _S123 = false;
    ...
    s_diff_Features_0 _S128 = Features_x24_syn_dzero_0();
    s_diff_Features_0 _S129;
    float3  _S130;
    if(_S122)
    {
        if(_S123)
        {
            if(_S124)
            {
                ...
                (&_S131)->primal_0 = _S120.primal_0;
                (&_S131)->differential_0 = _S127;
                DiffPair_Features_0 _S132;
                (&_S132)->primal_0 = _S121.primal_0;
                (&_S132)->differential_0 = _S128;
                s_bwd_prop_eval_sh_col3_0(&_S131, &_S132, _s_dOut_3);
                _S129 = Features_x24_syn_dadd_0(_S132.differential_0, _S128);
                _S130 = _S131.differential_0;
            }
            else
            {
                _S129 = _S128;
            ...
            (&_S133)->primal_0 = _S120.primal_0;
            (&_S133)->differential_0 = _S127;
            DiffPair_Features_0 _S134;
            (&_S134)->primal_0 = _S121.primal_0;
            (&_S134)->differential_0 = _S128;
            s_bwd_prop_eval_sh_col2_0(&_S133, &_S134, _s_dOut_3);
            float3  _S135 = _S133.differential_0 + _S130;
            _S129 = Features_x24_syn_dadd_0(_S134.differential_0, _S129);
            _S130 = _S135;
        }
        else
        {
        ...
        (&_S136)->primal_0 = _S120.primal_0;
        (&_S136)->differential_0 = _S127;
        DiffPair_Features_0 _S137;
        (&_S137)->primal_0 = _S121.primal_0;
        (&_S137)->differential_0 = _S128;
        s_bwd_prop_eval_sh_col1_0(&_S136, &_S137, _s_dOut_3);
        float3  _S138 = _S136.differential_0 + _S130;
        _S129 = Features_x24_syn_dadd_0(_S137.differential_0, _S129);
        _S130 = _S138;
    }
    else
    {
    ...
    (&_S139)->primal_0 = _S120.primal_0;
    (&_S139)->differential_0 = _S127;
    DiffPair_Features_0 _S140;
    (&_S140)->primal_0 = _S121.primal_0;
    (&_S140)->differential_0 = _S128;
    s_bwd_prop_eval_sh_col0_0(&_S139, &_S140, _s_dOut_3);
    s_diff_Features_0 _S141 = Features_x24_syn_dadd_0(_S140.differential_0, _S129);
    dpfeat_4->primal_0 = (*dpfeat_4).primal_0;
    dpfeat_4->differential_0 = _S141;
    float3  _S142 = _S139.differential_0 + _S130;
    dpdir_4->primal_0 = (*dpdir_4).primal_0;
    dpdir_4->differential_0 = _S142;
    return;
}

__device__ void s_bwd_eval_color_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S143, DiffPair_Features_0 * _S144, uint _S145, float3  _S146)
{
    s_bwd_prop_eval_color_0(_S143, _S144, _S145, _S146);
    return;
}

extern "C" {
__global__ void __kernel__bw_sh_kernel(TensorView means_1, TensorView sh0_2, TensorView features_2, TensorView dL_dsh0_0, TensorView dL_dfeatures_0, TensorView ray_origin_1, TensorView dL_dcolors_0, uint sh_degree_4)
{
    uint prim_ind_2 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    float _S147 = ((ray_origin_1).load<float>((0U)));
    float _S148 = ((ray_origin_1).load<float>((1U)));
    float _S149 = ((ray_origin_1).load<float>((2U)));
    float3  rayo_1 = make_float3 (_S147, _S148, _S149);
    uint _S150 = ((means_1).sizes[(0U)]);
    if(prim_ind_2 >= _S150)
    {
        return;
    }
    ...
    {
        _S151 = (F32_abs((deriv_color_0.y))) < 9.99999993922529029e-09f;
    }
    else
    {
        _S151 = false;
    ...
    if(_S151)
    {
        _S151 = (F32_abs((deriv_color_0.z))) < 9.99999993922529029e-09f;
    }
    else
    {
        _S151 = false;
    ...
    Features_0 feat_7 = get_feats_0(sh0_2, features_2, prim_ind_2, sh_degree_4);
    float3  _S152 = make_float3 (0.0f, 0.0f, 0.0f);
    DiffPair_vectorx3Cfloatx2C3x3E_0 deriv_direction_0;
    (&deriv_direction_0)->primal_0 = dir_pp_1;
    (&deriv_direction_0)->differential_0 = _S152;
    s_diff_Features_0 _S153 = { _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152, _S152 };
    DiffPair_Features_0 d_feat_0;
    (&d_feat_0)->primal_0 = feat_7;
    (&d_feat_0)->differential_0 = _S153;
    s_bwd_eval_color_0(&deriv_direction_0, &d_feat_0, sh_degree_4, deriv_color_0);
    add_float3_0(dL_dsh0_0, prim_ind_2, d_feat_0.differential_0.f0_1);
    if(sh_degree_4 > 0U)
    {
        add_float3_1(dL_dfeatures_0, prim_ind_2, 0U, d_feat_0.differential_0.f1_1);
        add_float3_1(dL_dfeatures_0, prim_ind_2, 1U, d_feat_0.differential_0.f2_1);
        add_float3_1(dL_dfeatures_0, prim_ind_2, 2U, d_feat_0.differential_0.f3_1);
        if(sh_degree_4 > 1U)
        {
            add_float3_1(dL_dfeatures_0, prim_ind_2, 3U, d_feat_0.differential_0.f4_1);
            add_float3_1(dL_dfeatures_0, prim_ind_2, 4U, d_feat_0.differential_0.f5_1);
            add_float3_1(dL_dfeatures_0, prim_ind_2, 5U, d_feat_0.differential_0.f6_1);
            add_float3_1(dL_dfeatures_0, prim_ind_2, 6U, d_feat_0.differential_0.f7_1);
            add_float3_1(dL_dfeatures_0, prim_ind_2, 7U, d_feat_0.differential_0.f8_1);
            if(sh_degree_4 > 2U)
            {
                add_float3_1(dL_dfeatures_0, prim_ind_2, 8U, d_feat_0.differential_0.f9_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 9U, d_feat_0.differential_0.f10_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 10U, d_feat_0.differential_0.f11_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 11U, d_feat_0.differential_0.f12_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 12U, d_feat_0.differential_0.f13_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 13U, d_feat_0.differential_0.f14_1);
                add_float3_1(dL_dfeatures_0, prim_ind_2, 14U, d_feat_0.differential_0.f15_1);
            }
        }
    }
    return;
